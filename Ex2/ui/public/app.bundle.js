  ...
  _createClass(IssueAddNavItem, [{
    ...
    value: function () {
      var _handleSubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
        var form, issue, query, data, history, id;
...
var IssueEdit = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IssueEdit, [{
    ...
    value: function onChange(e, naturalValue) {
      ...
      console.log("IssueEdit - onChange: ".concat(name, ", ").concat(value));
    ...
    value: function render() {
      ...
      if (id === null || id === undefined) {
        if (propsId != null) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Issue wth ID ".concat(propsId, " not found."));
        }
...
var IssueList = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IssueList, [{
    ...
    key: "render",
    value: function render() {
      var newLocal = this.state;
      var issues = newLocal.issues,
          toastVisible = newLocal.toastVisible,
          toastMessage = newLocal.toastMessage,
          toastType = newLocal.toastType;
      var match = this.props.match; // eslint-disable-next-line react/destructuring-assignment

      var hasFilter = this.props.location.search !== '';
...
function NavBar() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"].Header, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"].Brand, null, "Issue tracker")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Nav"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_bootstrap__WEBPACK_IMPORTED_MODULE_2__["LinkContainer"], {
    ...
    to: "/about"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["MenuItem"], null, "About"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Nav"], {
    pullRight: true
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            body = _context.sent;
            result = JSON.parse(body, jsonDateReviver); // showError('Juste pour tester la méthode showError');
            ...
            if (result.errors) {
              ...
              if (error.extensions.code === 'BAD_USER_INPUT') {
                details = error.extensions.exception.stacktrace.join('\n ');
